...
const Intro = () => (
  <IntroBox>
    ...
    <p><strong>The data analyzed and the findings presented in this first version of the COVID-19 micro site, cover the period elapsed from the beginning of the pandemic, January 2020 until the end of May 2021. The data schema created for this analysis is continuously updated as new data become available and further results and findings will be presented in future versions of this microsite.</strong></p>
  </IntroBox>
)
