...
<p>
  ...
  Our website uses cookies to improve your experience. We use cookies to provide a proper website function, to personalize content and ads and analyze our traffic. We also use cookies to remember your preferences and settings. This website collects personal data from you with the use of the following cookie types: Strictly necessary, Functional, Performance and Targeting cookies.
...
<h3>PERFORMANCE </h3>
<p>Performance cookies help website owners to understand how visitors interact with websites by collecting and reporting information anonymously. </p>
<h3>
...
<p>
  The website www.predicta.gr is owned by the company PREDICTA S.A. (hereinafter referred as the Company), which acts as a Controller with regards to the personal data described below. The Company is the exclusive administrator of the website in discussion and is responsible for the processing of the personal data you submit, in accordance with the applicable General Data Protection Regulation (EU 2016/679 - GDPR).
...
<p>
  In case the users of the website voluntarily provide their personal data (e.g. name, address, telephone number or email address) via our communication form regarding our seminars, the Company shall process them for the purpose of answering any of your inquiries on our seminars. mentioned below. Users may decline to provide personal information; however, in this case, we may be unable to deliver the services requested.

</p>  
<h3>3. The lawful basis we use to process your data</h3>
<p>Processing of your data is based on the following lawful bases of the performance of contract, your consent or the compliance with a legal or regulatory obligation.</p>
<h3>
...
<h3>5. Security</h3>
<p>The information we collect is kept secure via the use of administrative, technical and physical safeguards to protect it from loss, misuse, unauthorized access, disclosure or alteration.</p>

<h3>6. Third parties that process data for us</h3>
<p>
  ...
  It should be mentioned that the Company does not transfer your personal data outside of the EEA, nor does the Company proceed with the above-mentioned personal data to any automated decision making.
</p>

<h3>7. When do we delete your data?</h3>
<p>Your personal data are retained only for as long as it is required according to the terms of our contractual relationship.</p>
...
<p>
  ...
  You will receive a response to your request within one (1) month of its receipt. If an extension of two (2) months to respond to your request is required, considering the complexity and number of concurrent requests, we will inform you in due time.
...
<p>
  ...
  For more information regarding our privacy policy, or for relevant questions or comments, please email us at: info@predicta.gr
</p>
...
Your consent ID: 535VUaCCtj+cDIQRiuJDZ06nLOeP9zZOIijonGbZI/5WnHa7sKyXow==
Consent date: Day, Month xx, Year, xx:xx:xx AM/PM GMT+x

Change your consent (button) (Εμφανίζει το module με τα check boxes, όπως στο homepage)
Cookie declaration last updated on XX/XX/XX by PREDICTA:

Please state your consent ID and date when you contact us regarding your consent.

NECESSARY (number of cookies)
...
i.e __cfduid
i.e Cookiebot
i.e Used by the content network, Cloudflare, to identify trusted web traffic.
i.e 29 days or 1 year or Session or else
i.e HTTP Cookie or
HTML Local Storage or else
...
TARGETING & SOCIAL MEDIA (number of cookies)
Targeting cookies are used to track visitors across websites. The intention is to display ads that are relevant and engaging for the individual user and thereby more valuable for publishers and third-party advertisers.
