  ...
  return (
    <Wrapper>
      <Grid>
        ...
        <Item>
          <NavLink
            to="/europe/second-wave"
            activeStyle={{ backgroundColor: `#222b3e`, color: `white` }}
          >
            2nd & 3rd Wave <br /> of the Pandemic <br /> (Sep 20 to May 21)
          </NavLink>
        </Item>
        <Item>
          <NavLink
            to="/europe/vaccination"
            activeStyle={{ backgroundColor: `#222b3e`, color: `white` }}
          >
            Vaccination
          </NavLink>
        ...
        <Item>
          <NavLink
            ...
            activeStyle={{ backgroundColor: `#222b3e`, color: `white` }}
          >
            Measures Against<br></br>
            COVID-19
          </NavLink>
        </Item>
        <Item>
          <NavLink
            to="/europe/conclusion"
            activeStyle={{ backgroundColor: `#222b3e`, color: `white` }}
          >
            Conclusion
          </NavLink>
