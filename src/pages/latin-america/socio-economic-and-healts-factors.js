...
const SocioEconomicLatin = (props) => (
    <Layout location={props.location}>
        ...
        <div className="row" >
            <PredictaTextWrapper>
                <PredictaText marginBottom="40px">
                    Additionally, the informal employment rate in the Latin America countries is among the highest 
                    in the world. Closed to 50% of the labor force, is informally employed, even in the wealthier 
                    countries like Argentina and Chile. <br /> <br />
                    This situation complicates lockdown policies, as all the informally employed citizens, cannot 
                    be helped by supporting social policies, therefore they tend to go out to seek work. Apart 
                    from that, working from home is next to impossible as most of the working people have hands 
                    on jobs in agriculture, retail and construction. This is probably the main reason for lockdown 
                    relaxation respect, although the pandemic keeps increasing from June 2020 onwards.
                </PredictaText>
            </PredictaTextWrapper>
            <PredictaSubTitle >
        ...
        <div className="row" style={{backgroundColor: `#E8E8E8`}}>
            <PredictaTextWrapper>
                <PredictaText marginBottom="40px">
                    As lockdown rules are not respected, population mobility increases and the spread of the 
                    virus within the same household is inevitable. Given that the average household size is one 
                    of the highest in the world (3.7 household members per household) and the multigeneration 
                    cohabitation is also high (33%), the spread of the virus within the same household is 
                    further increased, affecting fatally the elderly members of the household.
                </PredictaText>
            </PredictaTextWrapper>
        ...
        <div className="row" >
            <PredictaTextWrapper>
                <PredictaText marginBottom="42px">
                    Examining the COVID-19 case age distribution below we see that over 70% of the cases are 
                    under the age of 50 years. Despite this positive factor with respect to the low risk of 
                    getting seriously sick from COVID-19 and dying, the anticipated effect is not experienced 
                    in Latin America.
                </PredictaText>
            </PredictaTextWrapper>
            <PredictaSubTitle>
        ...
        <div className="row" style={{backgroundColor: `#E8E8E8`}}>
            <PredictaTextWrapper>
                <PredictaText marginBottom="42px">
                    A potential explanation for this situation is the bad disease profiles of the population as 
                    described in the following graphs. Obesity rates, diabetes prevalence and cardiovascular 
                    disease which are factors that increase the probability to get seriously ill from COVID-19, 
                    are depicting significantly higher percentages compared to the global figures (again formed 
                    by European and North America countries).
                </PredictaText>
            </PredictaTextWrapper>
