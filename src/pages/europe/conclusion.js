...
const europeConclusionMetadata = {
  ...
  Description:
    "Europe has been hit severely by the pandemic with Western Europe slightly more so than Eastern Europe ",
  ...
  <Layout location={props.location}>
    ...
    <div className="row" id="first-section">
      <div className="col">
        ...
        <TextBox>
          <p>
            As a conclusion, we can say that the pandemic hit Europe severely.
            In the first wave, western countries had a high number of cases and
            deaths. COVID-19 hit especially prosperous countries with high
            mobility in their airports. Eastern countries had a little more time
            for preventive actions, so they minimized the spread of the virus
            during the first wave. Another important issue is that half of the
            deaths in first wave took place in elderly care homes, demonstrating
